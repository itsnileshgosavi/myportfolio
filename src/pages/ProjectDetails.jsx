...
const myprojects = [
  {
    ...
    name: "CraftMyMenu",
    description:
      "CraftMyMenu isa Digital Menu cum Ordering system(SAAS) for Restaurants, Hotels and cafes. It allows restaurants to create a digital menu from which the users can place order contactlessly.",
